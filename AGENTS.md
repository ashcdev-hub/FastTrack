...
| 17 | **My Meals library** | Small | Save reusable meals/recipes with known macros, names, and portions. One-tap log from a "My Meals" grid — distinct from recent foods (these are curated, user-named, with adjustable serving sizes). Syncs across devices via profiles table. |
