      ...
      <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} className="flex-1">
        <View className="flex-1 justify-center px-6">
          <View className="flex-row justify-center items-center gap-3 mb-2">
            ...
            <Text style={{ color: accent.lime, fontFamily: "Inter_800ExtraBold", fontSize: 48, letterSpacing: -1 }}>
              FastTrack
            </Text>
          </View>
          <Text style={{ color: c.textMuted, fontFamily: "Inter_400Regular", fontSize: 16, textAlign: "center", marginBottom: 40 }}>
